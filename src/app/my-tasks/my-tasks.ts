...
defineComponents(IgcBadgeComponent, IgcListComponent, IgcListItemComponent, IgcIconComponent, IgcButtonComponent, IgcRippleComponent, IgcIconButtonComponent, IgcAvatarComponent, IgcCalendarComponent);
      ...
      <div class="column-layout content_section">
        ...
        <div class="row-layout group_3">
          <div class="column-layout group_4">
            ...
            <igc-button variant="flat" class="button_3">
              <span class="material-icons">
                add
              </span>
              <span>task</span>
